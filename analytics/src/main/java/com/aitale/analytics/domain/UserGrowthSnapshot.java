...
@Entity
@Table(
    name = "user_growth_snapshot",
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uk_user_growth_snapshot_user_date",
...
public class UserGrowthSnapshot {
    ...
    public void applyDelta(
        ...
        this.overallCorrectRate = this.totalQuizCount == 0
            ? 0.0
            : (double) this.totalCorrectCount / this.totalQuizCount;
        this.updatedAt = updatedAt;
    }
}